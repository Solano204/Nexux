...
/**
 * Local JWT Validator — RS256 signature verification + claims extraction
 * for tokens signed by nexus-identity-service's local keystore.
 *
 * This is the unchanged, always-available auth path ("Option A" in
 * AWS-DOCKER-WORKFLOWS/02_LOGIN_FLOW.md). See CognitoJwtValidator for the
 * "Option B" Cognito path; CompositeJwtValidator routes between the two.
 *
