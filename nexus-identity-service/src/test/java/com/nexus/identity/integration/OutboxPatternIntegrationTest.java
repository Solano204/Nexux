...
class OutboxPatternIntegrationTest {
    ...
    void register_writesUserRegisteredToOutbox() throws Exception {
        ...
        // aggregateType is the outbox/Debezium topic name, not the entity
        // name - confirmed against the real writeOutboxEntry("users.registered", ...)
        // call in UserCommandService.register().
        assertThat(newEntry.getAggregateType()).isEqualTo("users.registered");
